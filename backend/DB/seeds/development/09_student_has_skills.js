  ...
  return knex('student_has_skills').del()
    .then(function () {
      ...
      return knex('student_has_skills').insert([
        ...
        {student_id: students[1].id, skill_id: skills[1].id},
        {student_id: students[1].id, skill_id: skills[2].id},
        {student_id: students[1].id, skill_id: skills[17].id},
        {student_id: students[2].id, skill_id: skills[1].id},
        {student_id: students[2].id, skill_id: skills[2].id},
        {student_id: students[2].id, skill_id: skills[3].id},
        {student_id: students[2].id, skill_id: skills[18].id},
        {student_id: students[2].id, skill_id: skills[19].id},
        {student_id: students[3].id, skill_id: skills[3].id},
        {student_id: students[3].id, skill_id: skills[21].id},
        {student_id: students[4].id, skill_id: skills[4].id},
        {student_id: students[4].id, skill_id: skills[5].id},
        {student_id: students[4].id, skill_id: skills[6].id},
        {student_id: students[4].id, skill_id: skills[20].id},
        {student_id: students[4].id, skill_id: skills[21].id},
        {student_id: students[5].id, skill_id: skills[7].id},
        {student_id: students[5].id, skill_id: skills[17].id},
        {student_id: students[6].id, skill_id: skills[8].id},
        {student_id: students[6].id, skill_id: skills[9].id},
        {student_id: students[6].id, skill_id: skills[12].id},
        {student_id: students[7].id, skill_id: skills[2].id},
        {student_id: students[7].id, skill_id: skills[19].id},
        {student_id: students[8].id, skill_id: skills[5].id},
        {student_id: students[8].id, skill_id: skills[7].id},
        {student_id: students[8].id, skill_id: skills[16].id},
        {student_id: students[8].id, skill_id: skills[17].id},
        {student_id: students[9].id, skill_id: skills[10].id},
        {student_id: students[9].id, skill_id: skills[11].id},
        {student_id: students[9].id, skill_id: skills[12].id},
